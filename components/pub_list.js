...
// update the heading
let heading = document.querySelector('header.autoheader');
if (heading) {
    // prepare the links
    let link1 = '';
    let link2 = '';
    ...
    if (window.location.href.indexOf("index.html") > -1) {
        link1 = `the <a href="CV_no_sides.html" class="bold-a italic-a">print-friendly version</a></span>`;
        link2 = `<a href="Teaching.html" class="bold-a italic-a">teaching</a>`;
        link3 = `<a href="CV_no_sides.html" class="bold-a italic-a">other activities</a>`;
    } else if (window.location.href.indexOf("CV_no_sides.html") > -1) {
        link1 = `the <a href="index.html" class="bold-a italic-a">interactive version</a>`;
        link2 = `<a href="Teaching.html" class="bold-a italic-a">teaching</a>`;
        link3 = `<a href="Activities.html" class="bold-a italic-a">other activities</a>`;
    } else if (window.location.href.indexOf("Teaching.html") > -1) {
        link1 = `<a class="bold-a italic-a" href="Activities.html">other activities</a>`;
        link2 = `<a href="index.html" class="bold-a italic-a">interactive</a>`;
        link3 = `<a href="CV_no_sides.html" class="bold-a italic-a">print-friendly version</a>`;
    } else if (window.location.href.indexOf("Activities.html") > -1) {
        link1 = `<a class="bold-a italic-a" href="Teaching.html">teaching & supervision activities</a>`;
        link2 = `<a href="index.html" class="bold-a italic-a">interactive</a></span>`;
        link3 = `<span class="link2"><a href="CV_no_sides.html" class="bold-a italic-a">print-friendly version</a>`;
    }


    // replace
    heading.innerHTML = `<h1 class="caption"><a href="https://www.falmouth.ac.uk/staff/dr-daniel-zhang"
                title="visit Dr Xu Zhang's university profile page" target="_blank"><span class="blue">Dr Daniel (Xu)
                    Zhang</span></a>
        </h1>
        <span class="hidden">
            <a href="img/zhang1.wav" target="_blank" title="Zhang1"><img class="img-zoom-15" src="img/zhang.gif"
                    height="40" title="click to listen to the sound clip of surname"
                    alt="Pronunciation of Chinese character Zhang" /></a>&nbsp;
            <a href="img/xu4.wav" target="_blank" title="Xu4"><img class="img-zoom-15" src="img/xu.gif" height="40"
                    title="click to listen to the sound clip of given name"
                    alt="Pronunciation of Chinese character Xu" /></a>
        </span>
        <span class="right-align-inline">(v. <span id="version"></span>)</span>

        <hr width="100%" size="3" color="black">
        <span class="bold-a">Senior Lecturer & Module Leader, PhD, MSc, BEng, FHEA<br>
            Specialised in Artificial Intelligence, Machine Learning, Neural Networks, Design Optimisation, and
            Computational Engineering</span><br>
        <span class="hidden">
            <span class="smalltext"> >>> View ${link1} or the ${link2} and ${link3}</span>

            <h3 class="bold-a red">PhD Supervision Opportunities</h3>
            <p>
                I am currently accepting applications from prospective PhD students in <a class="bold-a italic-a">AI/ML
                    applications</a> and <a class="bold-a italic-a">Digital Games
                    Research</a>. If you are driven, innovative, and
                eager to contribute to impactful research, please
                contact me with your CV and research interests.</p>
        </span>`;
}
...
if (window.location.href.indexOf("index.html") > -1 ||
    ...
    let publicationSection = document.querySelector('article.publication');
    if (publicationSection) {
        publicationSection.innerHTML = `<h3 class="caption">Publication List</h3>
